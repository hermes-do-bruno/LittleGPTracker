...
#define I_CMD_EQF1 MAKE_FOURCC('E','Q','F','1')
#define I_CMD_EQG1 MAKE_FOURCC('E','Q','G','1')
#define I_CMD_EQF2 MAKE_FOURCC('E','Q','F','2')
#define I_CMD_EQG2 MAKE_FOURCC('E','Q','G','2')
#define I_CMD_EQF3 MAKE_FOURCC('E','Q','F','3')
#define I_CMD_EQG3 MAKE_FOURCC('E','Q','G','3')
#define I_CMD_EQF4 MAKE_FOURCC('E','Q','F','4')
#define I_CMD_EQG4 MAKE_FOURCC('E','Q','G','4')
#define I_CMD_EQF5 MAKE_FOURCC('E','Q','F','5')
